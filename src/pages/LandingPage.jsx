...
function CTACard() {
  return (
    <Link
      to="/events"
      className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-6 border-2 border-dashed border-slate-300 hover:border-slate-400 transition-all hover:-translate-y-1 flex flex-col items-center justify-center text-center min-h-[300px]"
    >
      ...
      <h3 className="font-semibold text-slate-700 text-lg mb-2 landing-heading">
        Get started with Checkins today!
      </h3>
      <p className="text-sm text-slate-500">
        Create your own passport experience
      </p>
    </Link>
  );
}
      ...
      <section className="pt-32 pb-20 px-10 md:px-6 relative min-h-[80vh] flex items-center">
        ...
        >
          ...
          >
            ...
            Track progress, unlock achievements, create excitement at your next party or event.
          </motion.p>
          <motion.div
            className="flex flex-col sm:flex-row gap-4 justify-center"
            variants={fadeInUp}
          >
            <button onClick={scrollToPricing} className="landing-btn-primary">
              Host Event
            </button>
            <button
        ...
        <div className="landing-container mx-auto">
          ...
          >
            ...
            >
              ...
              <button className="block w-full text-center bg-white text-slate-800 font-semibold px-6 py-3 rounded-xl border-2 border-slate-300 hover:border-slate-400 hover:bg-slate-50 transition-colors">
                Contact Us
              </button>
            </motion.div>
