...
export const voiceLines = {
  ...
  'cullen-origins': quote('Jasper', 'jasper', 'I thought what I had with Maria was love.', 'eclipse'),
...
export const performances = {
  ...
  'cullen-origins': { tags: ['reflective', 'regretful'], intent: 'An old mistake admitted quietly; a small hurt underneath the word love.' },
