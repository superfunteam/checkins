...
const films = [
  { id: 'twilight', name: 'Twilight', start: '11:00', end: '12:57', edition: 'Extended Edition' },
  { id: 'new-moon', name: 'New Moon', start: '13:05', end: '15:10', edition: 'Extended Edition' },
  { id: 'eclipse', name: 'Eclipse', start: '15:20', end: '17:23', edition: 'Extended Edition' },
  { id: 'breaking-dawn-1', name: 'Breaking Dawn – Part 1', start: '17:30', end: '19:22', edition: 'Extended Edition' },
  { id: 'breaking-dawn-2', name: 'Breaking Dawn – Part 2', start: '19:30', end: '21:23', edition: 'Theatrical Edition' },
];
...
add('new-moon', 'movie', 'New Moon', '3:10pm ish', 'Second film complete', 'Heartbreak, motorcycles, emergency Italy. Bella and Edward reunite, but the Volturi have conditions. Two films down; nobody can make a simple call.', 'FINAL NEW MOON MOVIE ACHIEVEMENT. A copper full moon over La Push sea cliffs, a powerful russet wolf on the cliff, Bella and Edward reunited fully clothed in the lower center, distant Italian clock tower suggested in mist. Epic wistful painted cover with gold and dark teal.', { startTime: '1:05pm ish', edition: 'Extended Edition' });
add('late-night-snack', 'meal', 'Snack Break', '3:15pm ish', 'Team Sweet or Salty', 'Team Sweet. Team Salty. Finally, a rivalry solved by having both. Grab a bite before Eclipse turns up the heat.', 'A lavish snack-break still life of overflowing popcorn, chocolate squares, fresh strawberries, pretzels and steaming mugs on a rustic cedar table; a rainlit window, low copper moon, red napkin. Inviting lush painterly game feast, no people.');

scene('eclipse', 'cullen-origins', 'A Century of Secrets', '0:47:00', 'The Cullen backstories', 'Before the Cullens were family, each had another life. Rosalie and Jasper reveal the memories behind those golden eyes.', 'A century of Cullen family history: an antique silver pocket watch, aged family portrait of elegant pale Edward and Carlisle in early twentieth-century civilian suits, a weathered journal, dried white rose, modern glass Cullen home glimpsed through forest mist. Deep reflective gilded oil painting, no readable writing.');
...
add('eclipse', 'movie', 'Eclipse', '5:23pm ish', 'Third film complete', 'Newborn army defeated. Tent diplomacy survived. Bella chooses her future. Three films down; Alice can finally start planning that wedding.', 'FINAL ECLIPSE MOVIE ACHIEVEMENT. A magnificent eclipsed sun crowns two intersecting silver and red ribbons, a white rose and a wolf silhouetted below, fully clothed Bella with Edward and Jacob at either side in a misty mountain panorama. Elegant epic painted romance composition.', { startTime: '3:20pm ish', edition: 'Extended Edition' });
...
add('breaking-dawn-1', 'movie', 'Breaking Dawn – Part 1', '7:22pm ish', 'Fourth film complete', 'Vows exchanged. Pillows destroyed. Renesmee born. Bella opens her eyes to a new life. Four films down; forever just got complicated.', 'FINAL BREAKING DAWN PART ONE ACHIEVEMENT. Two intertwined silver wedding rings rest atop white wedding petals, a crimson dawn reflected in a large luminous feminine eye suggested subtly in clouds, white feathers drift over a tropical ocean merging into blue forest. Symbolic elegant oil-painted finale.', { startTime: '5:30pm ish', edition: 'Extended Edition' });
add('dinner', 'meal', 'Dinner', '7:25pm ish', 'Feed your coven', 'Four films behind you. One snowfield ahead. Gather your coven and eat like a human. Forever can wait five minutes.', 'Lavish candlelit dinner in the Cullen glass house, roasted vegetables, pasta, crusty bread and sparkling water on a long elegant table, red cloth napkins, white flowers, twilight forest through enormous windows. Warm welcoming epic painted feast, no people.');
...
add('breaking-dawn-2', 'movie', 'Breaking Dawn – Part 2', '9:23pm ish', 'Final film complete', 'Bella shares her memories with Edward. The family has a future. Five films down; farewell credits end around 9:32.', 'FINAL BREAKING DAWN PART TWO ACHIEVEMENT. Adult Bella and Edward fully clothed embrace tenderly in a luminous wildflower meadow, their child Renesmee safely playing at a distance, brilliant dawn beyond dark evergreen mountains, subtle shield-like silver halo. Hopeful sumptuous romance novel final-page oil painting.', { startTime: '7:30pm ish', edition: 'Theatrical Edition' });
...
passport.schedule = { dayStart: '10:30', dayEnd: '21:32' };
...
passport.content.explainer.body = [
  'Five films, twenty scenes, four meals. Rain, romance, questionable decisions. Brunch and Twilight start at 11.',
